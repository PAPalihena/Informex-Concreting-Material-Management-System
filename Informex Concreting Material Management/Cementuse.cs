...
{
    public partial class Cementuse : Form
    ...
    {   
        ...
        private void btncementin_Click(object sender, EventArgs e)
        {
            ...
            if (con.State == System.Data.ConnectionState.Open)
            {
                try
                {
                    SqlDataAdapter cmd = new SqlDataAdapter("INSERT INTO Cement_stockin (date,quantity,Supplier_id) VALUES ('" + this.dateTimePicker1.Text + "','" + txtcquan.Text + "','" + txtcementsup.Text + "')", con);
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            if (con.State == System.Data.ConnectionState.Open)
            {
                try
                {
                    SqlCommand cmd1 = new SqlCommand("getCementSuppliers", con);
                    ...
                    String selectquery = "SELECT cement_in,cement_out FROM material_usage WHERE date = '" + this.dateTimePicker1.Text + "'";
        ...
        private void btncementout_Click(object sender, EventArgs e)
        {
            ...
            if (con.State == System.Data.ConnectionState.Open)
            {
                try
                {
                    SqlDataAdapter cmd2 = new SqlDataAdapter("INSERT INTO cement_out (date,quantity,concrete_id) VALUES ('" + this.dateTimePicker1.Text + "','" + textBox7.Text + "','" + textBox6.Text + "')", con);
